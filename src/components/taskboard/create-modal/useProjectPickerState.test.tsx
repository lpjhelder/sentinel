...
describe("useProjectPickerState native picker fallback", () => {
  ...
  beforeEach(() => {
    ...
    apiMocks.browseProjectPath.mockResolvedValue({
      current_path: "D:\\AI\\claw-republic",
      parent_path: "D:\\AI",
      entries: [],
      truncated: false,
    });
  ...
  it("opens in-app folder browser when native picker fails", async () => {
    ...
    act(() => {
      ...
      result.current.setNewProjectPath("D:\\AI\\claw-republic");
    });
    ...
    expect(apiMocks.browseProjectPath).toHaveBeenCalledWith("D:\\AI\\claw-republic");
