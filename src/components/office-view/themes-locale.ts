...
const LOCALE_TEXT = {
  ...
  reviewLines: {
    ...
    pt: [
      "Verificando atualizações de acompanhamento",
      "Revisando rascunho de aprovação final",
      "Compartilhando ideias de revisão",
      "Verificação cruzada de entregas",
    ],
  },
  meetingTableHint: {
...
const BREAK_CHAT_MESSAGES: Record<SupportedLocale, string[]> = {
  ...
  pt: [
    ...
    "Esse projeto tá puxado kkk",
    "Café com leite é vida!",
    "Que dia lindo hoje~",
    "Não quero fazer hora extra...",
    "Tô com vontade de comer algo gostoso",
    "Vamos dar uma pausinha~",
    "kkkkk",
    "Chegaram os lanchinhos!",
