/**
 * Claw-Republic Introduction Presentation Generator
...
pptx.company = "Claw-Republic";
pptx.subject = "Claw-Republic Introduction";
pptx.title = "Claw-Republic — AI Agent Office Simulator";
...
// ═══════════════════════════════════════════════
{
  ...
  s.addText("github.com/GreenSheep01201/claw-republic", {
    x: 0.8,
    y: 4.8,
    w: 8,
    h: 0.3,
    ...
    fontFace: "Arial",
    color: C.textDim,
    hyperlink: { url: "https://github.com/GreenSheep01201/claw-republic" },
  });
}
...
// ═══════════════════════════════════════════════
{
  ...
  const links = [
    ["GitHub", "github.com/GreenSheep01201/claw-republic"],
    ["License", "Apache 2.0"],
