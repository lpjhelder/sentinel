              ...
              l(
                [
                  recentLines.length > 0
                    ...
                    : "기존 프로젝트 목록이 비어 있습니다. 프로젝트 절대경로(예: /Users/classys/Projects/claw-republic) 또는 기존 프로젝트 이름을 보내주세요.",
                ],
                [
                  recentLines.length > 0
                    ...
                    : "No recent existing projects found. Send an absolute project path (e.g. /Users/classys/Projects/claw-republic) or an existing project name.",
                ],
                [
                  recentLines.length > 0
        ...
        if (pendingBinding.state === "ask_new_name") {
          ...
          if (!newProjectName) {
            const askNameAgain = pickL(
              l(
                ["신규 프로젝트 이름을 다시 알려주세요. 예: claw-republic-redesign"],
                ["Please provide the new project name again. Example: claw-republic-redesign"],
                ["新規プロジェクト名をもう一度送ってください。例: claw-republic-redesign"],
                ["请重新提供新项目名称。例如：claw-republic-redesign"],
              ),
              lang,
            );
            replyRuntime.sendInCharacterAutoMessage({
          ...
          const askNewPath = pickL(
            l(
              ["신규 프로젝트 절대경로를 보내주세요. 예: /Users/classys/Projects/claw-republic-redesign"],
              ["Send the new project's absolute path. Example: /Users/classys/Projects/claw-republic-redesign"],
              ["新規プロジェクトの絶対パスを送ってください。例: /Users/classys/Projects/claw-republic-redesign"],
              ["请发送新项目绝对路径。例如：/Users/classys/Projects/claw-republic-redesign"],
            ),
            lang,
          );
          replyRuntime.sendInCharacterAutoMessage({
        ...
        if (pendingBinding.state === "ask_new_path") {
          ...
          if (!providedPath) {
            const askPathAgain = pickL(
              l(
                ["절대경로 형식으로 다시 보내주세요. 예: /Users/classys/Projects/claw-republic-redesign"],
                ["Please send it again as an absolute path. Example: /Users/classys/Projects/claw-republic-redesign"],
                ["絶対パス形式で再送してください。例: /Users/classys/Projects/claw-republic-redesign"],
                ["请用绝对路径格式重新发送。例如：/Users/classys/Projects/claw-republic-redesign"],
              ),
              lang,
            );
            replyRuntime.sendInCharacterAutoMessage({
