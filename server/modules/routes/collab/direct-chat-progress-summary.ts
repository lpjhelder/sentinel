...
function resolveProgressStatusLabel(status: string, lang: Lang): string {
  const labels: Record<string, Record<Lang, string>> = {
    inbox: { ko: "접수", en: "Inbox", ja: "受信", zh: "收件", pt: "Caixa de entrada" },
    planned: { ko: "계획", en: "Planned", ja: "計画", zh: "计划", pt: "Planejado" },
    collaborating: { ko: "협업", en: "Collaborating", ja: "協業", zh: "协作", pt: "Colaborando" },
    in_progress: { ko: "진행", en: "In Progress", ja: "進行中", zh: "进行中", pt: "Em andamento" },
    review: { ko: "검토", en: "Review", ja: "レビュー", zh: "评审", pt: "Revisão" },
    pending: { ko: "보류", en: "Pending", ja: "保留", zh: "待处理", pt: "Pendente" },
    done: { ko: "완료", en: "Done", ja: "完了", zh: "完成", pt: "Concluído" },
    cancelled: { ko: "취소", en: "Cancelled", ja: "取消", zh: "取消", pt: "Cancelado" },
  };
