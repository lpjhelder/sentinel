...
- Cached at `{projectPath}/.sentinel/project-context.md`
...
- If project has no existing `CLAUDE.md`, generates `.sentinel/CLAUDE.md` with abbreviated project context
...
- Verify after restart:
  1. Assign task to any project → `.sentinel/project-context.md` created
