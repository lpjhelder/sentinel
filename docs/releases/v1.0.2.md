# Claw-Republic v1.0.2 Release Notes
...
- Cached at `{projectPath}/.claw-republic/project-context.md`
...
- If project has no existing `CLAUDE.md`, generates `.claw-republic/CLAUDE.md` with abbreviated project context
...
- Verify after restart:
  1. Assign task to any project → `.claw-republic/project-context.md` created
