...
- **Hotfix 2: Setup Frontend Port Output Correction**
  - `scripts/opensentinel-setup.sh` and `scripts/opensentinel-setup.ps1` now print the correct frontend URL:
    - `http://127.0.0.1:8800`
...
### Setup Scripts
- `scripts/opensentinel-setup.sh`
- `scripts/opensentinel-setup.ps1`
